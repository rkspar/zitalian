...
(function ($) {
    ...
    if ( document.getElementById("map") && typeof google === "object" ) {
        ...
        var locations = [
            [
            	'<address>Zuckerellos Italian Restaurant<br><strong>Address<br></strong> 3017 East Commercial Blvd <br> Fort Lauderdale, Florida 33308 <br> <strong>Phone<br></strong> (954) 776-4282 </address>',
            	26.190214,
            	-80.106377
        	]
        ];
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
            zoom: 14,
            center: new google.maps.LatLng(26.190214, -80.106377), // Map Center coordinates
            scrollwheel: false,
